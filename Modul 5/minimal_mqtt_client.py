...
Usage: python minimal_server.py <filename> (optional, default:Sensor_Data.csv)
"""
...
try:
   ...
   print('Error, Module paho-mqtt is required')
...
def connect_mqtt():
    ...
    client.publish(status_topic, 'Sensor online', qos=1, retain=True)
    return client
...
if __name__ == "__main__":
    ...
    try:
        ...
        client.publish(status_topic, 'Sensor offline', qos=1, retain=True)
        client.loop_stop()
        client.disconnect() 
